...
export default function AdminDashboard() {
  ...
  return (
    <Box sx={{ p: 2 }}>
      ...
      <Card sx={{ mb: 3 }}>
        <CardContent>
          <Typography fontWeight="bold">Geo Events – Last 7 Days</Typography>
      ...
      <Stack direction="row" spacing={2}>
        ...
        <TextField type="date" label="Created After" InputLabelProps={{ shrink: true }} value={dateFrom} onChange={(e) => setDateFrom(e.target.value)} />
            ...
            <Box>
              ...
              {mainTab === 1 && (
                <TextField
                  ...
                  value={d.expiryDate?.toDate ? d.expiryDate.toDate().toISOString().slice(0, 10) : ""}
                  onChange={(e) =>
      ...
      <Dialog open={Boolean(rejectingMerchant)} onClose={() => setRejectingMerchant(null)}>
        ...
        <DialogContent>
          <TextField fullWidth multiline rows={3} value={reason} onChange={(e) => setReason(e.target.value)} placeholder="Reason" />
        </DialogContent>
        <DialogActions>
