...
var findTimeout = (time4) => ~(~timeouts.findIndex((t7) => t7.time > time4) || ~timeouts.length);
raf.cancel = (fn) => {
...
function normalizeColor(color5) {
  ...
  if (match = hex6.exec(color5)) return parseInt(match[1] + "ff", 16) >>> 0;
  if (colors$1 && colors$1[color5] !== void 0) {
    return colors$1[color5];
  }
  ...
  if (match = hex8.exec(color5)) return parseInt(match[1], 16) >>> 0;
...
function hue2rgb(p3, q, t7) {
  if (t7 < 0) t7 += 1;
  if (t7 > 1) t7 -= 1;
  if (t7 < 1 / 6) return p3 + (q - p3) * 6 * t7;
  if (t7 < 1 / 2) return q;
  if (t7 < 2 / 3) return p3 + (q - p3) * (2 / 3 - t7) * 6;
  return p3;
}
...
function removeFluidObserver(target, observer) {
  ...
  if (observers && observers.has(observer)) {
    ...
    if (target.observerRemoved) {
      target.observerRemoved(count4, observer);
    }
  }
}
...
var FrameValue = class extends FluidValue {
  ...
  observerAdded(count4) {
    if (count4 == 1) this._attach();
  }
  observerRemoved(count4) {
    if (count4 == 0) this._detach();
  }
  _attach() {
  }
  _detach() {
...
function createLoopUpdate(props, loop2 = props.loop, to3 = props.to) {
  ...
  if (loopRet) {
    ...
    return createUpdate(_extends3({}, props, {
      ...
      default: false,
      pause: void 0,
      to: !reverse4 || isAsyncTo(to3) ? to3 : void 0,
...
var SpringRef = () => {
  ...
  const _getProps = function _getProps2(arg, ctrl, index4) {
...
function useTransition(data, props, deps) {
  ...
  const reused = [];
  if (prevTransitions) each(prevTransitions, (t7, i3) => {
    if (t7.expired) {
      clearTimeout(t7.expirationId);
      expired.push(t7);
    } else {
      i3 = reused[i3] = keys.indexOf(t7.key);
      if (~i3) transitions[i3] = t7;
    }
  });
  each(items, (item, i3) => {
    if (!transitions[i3]) {
      ...
      if (t8.ctrl.idle) {
        ...
        if (t8.phase == TransitionPhase.LEAVE) {
          ...
          if (expiry !== false) {
            ...
            t8.expired = true;
            if (!idle && expiryMs > 0) {
              if (expiryMs <= 2147483647) t8.expirationId = setTimeout(forceUpdate, expiryMs);
              return;
            }
          }
        }
  ...
  constructor(_ref) {
    ...
    eachProp(style, (value, key) => {
      if (key === "transform") {
        ...
        transforms.push(key === "rotate3d" ? ([x6, y5, z3, deg]) => [`rotate3d(${x6},${y5},${z3},${addUnit(deg, unit)})`, isValueIdentity(deg, 0)] : (input) => [`${key}(${input.map((v4) => addUnit(v4, unit)).join(",")})`, isValueIdentity(input, key.startsWith("scale") ? 1 : 0)]);
      }
    });
    if (inputs.length) {
...
var FluidTransform = class extends FluidValue {
  ...
  observerAdded(count4) {
    if (count4 == 1) each(this.inputs, (input) => each(input, (value) => hasFluidValue(value) && addFluidObserver(value, this)));
  }
  observerRemoved(count4) {
    if (count4 == 0) each(this.inputs, (input) => each(input, (value) => hasFluidValue(value) && removeFluidObserver(value, this)));
  }
  eventObserved(event) {
    if (event.type == "change") {
      this._value = null;
...
function hslConvert(o3) {
  ...
  o3 = o3.rgb();
  var r4 = o3.r / 255, g3 = o3.g / 255, b4 = o3.b / 255, min5 = Math.min(r4, g3, b4), max5 = Math.max(r4, g3, b4), h3 = NaN, s4 = max5 - min5, l3 = (max5 + min5) / 2;
  if (s4) {
...
define_default(Cubehelix, cubehelix, extend(Color, {
  ...
  rgb: function() {
    var h3 = isNaN(this.h) ? 0 : (this.h + 120) * radians, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh5 = Math.cos(h3), sinh5 = Math.sin(h3);
    return new Rgb(
...
var rgb_default = function rgbGamma(y4) {
  var color5 = gamma(y4);
  function rgb6(start2, end) {
    var r4 = color5((start2 = rgb2(start2)).r, (end = rgb2(end)).r), g3 = color5(start2.g, end.g), b4 = color5(start2.b, end.b), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.r = r4(t7);
      start2.g = g3(t7);
      start2.b = b4(t7);
...
function rgbSpline(spline) {
  return function(colors2) {
    var n3 = colors2.length, r4 = new Array(n3), g3 = new Array(n3), b4 = new Array(n3), i3, color5;
    for (i3 = 0; i3 < n3; ++i3) {
      color5 = rgb2(colors2[i3]);
      r4[i3] = color5.r || 0;
      g3[i3] = color5.g || 0;
      b4[i3] = color5.b || 0;
    }
...
function string_default(a4, b4) {
  ...
  return s4.length < 2 ? q[0] ? one(q[0].x) : zero(b4) : (b4 = q.length, function(t7) {
    for (var i4 = 0, o3; i4 < b4; ++i4) s4[(o3 = q[i4]).i] = o3.x(t7);
    return s4.join("");
  });
}
...
function decompose_default(a4, b4, c8, d3, e6, f4) {
  ...
  if (skewX = a4 * c8 + b4 * d3) c8 -= a4 * skewX, d3 -= b4 * skewX;
  if (scaleY = Math.sqrt(c8 * c8 + d3 * d3)) c8 /= scaleY, d3 /= scaleY, skewX /= scaleY;
  if (a4 * d3 < b4 * c8) a4 = -a4, b4 = -b4, skewX = -skewX, scaleX = -scaleX;
  return {
    translateX: e6,
    translateY: f4,
...
function interpolateTransform(parse, pxComma, pxParen, degParen) {
  ...
  return function(a4, b4) {
    ...
    return function(t7) {
      ...
      while (++i3 < n3) s4[(o3 = q[i3]).i] = o3.x(t7);
      return s4.join("");
    };
  };
}
...
function hsl3(hue5) {
  return function(start2, end) {
    var h3 = hue5((start2 = hsl2(start2)).h, (end = hsl2(end)).h), s4 = nogamma(start2.s, end.s), l3 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.s = s4(t7);
      start2.l = l3(t7);
...
function hcl2(hue5) {
  return function(start2, end) {
    var h3 = hue5((start2 = hcl(start2)).h, (end = hcl(end)).h), c8 = nogamma(start2.c, end.c), l3 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.c = c8(t7);
      start2.l = l3(t7);
...
function cubehelix2(hue5) {
  return function cubehelixGamma(y4) {
    ...
    function cubehelix9(start2, end) {
      var h3 = hue5((start2 = cubehelix(start2)).h, (end = cubehelix(end)).h), s4 = nogamma(start2.s, end.s), l3 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
      return function(t7) {
        start2.h = h3(t7);
        start2.s = s4(t7);
...
function shuffler(random) {
  return function shuffle(array4, i0 = 0, i1 = array4.length) {
    let m4 = i1 - (i0 = +i0);
    while (m4) {
      const i3 = random() * m4-- | 0, t7 = array4[m4 + i0];
...
function ordinal() {
  var index4 = /* @__PURE__ */ new Map(), domain = [], range2 = [], unknown = implicit;
  function scale(d3) {
    ...
    return range2[(i3 - 1) % range2.length];
  }
...
function locale_default(locale7) {
  ...
  function newFormat(specifier) {
    ...
    function format4(value) {
      ...
      if (comma && !zero3) value = group4(value, Infinity);
      var length = valuePrefix.length + value.length + valueSuffix.length, padding = length < width ? new Array(width - length + 1).join(fill) : "";
      if (comma && zero3) value = group4(padding + value, padding.length ? width - valueSuffix.length : Infinity), padding = "";
      switch (align) {
        case "<":
...
function ticker(year3, month3, week, day3, hour3, minute3) {
  ...
  function tickInterval(start2, stop2, count4) {
    ...
    if (i3 === tickIntervals.length) return year3.every(tickStep(start2 / durationYear, stop2 / durationYear, count4));
    if (i3 === 0) return millisecond_default.every(Math.max(tickStep(start2, stop2, count4), 1));
...
function formatLocale(locale7) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      var string = [], i3 = -1, j2 = 0, n3 = specifier.length, c8, pad4, format4;
      if (!(date instanceof Date)) date = /* @__PURE__ */ new Date(+date);
      while (++i3 < n3) {
        if (specifier.charCodeAt(i3) === 37) {
          string.push(specifier.slice(j2, i3));
          if ((pad4 = pads[c8 = specifier.charAt(++i3)]) != null) c8 = specifier.charAt(++i3);
          else pad4 = c8 === "e" ? " " : "0";
          if (format4 = formats2[c8]) c8 = format4(date, pad4);
          string.push(c8);
          j2 = i3 + 1;
        }
      }
...
function colors_default(specifier) {
  ...
  while (i3 < n3) colors2[i3] = "#" + specifier.slice(i3 * 6, ++i3 * 6);
  return colors2;
}
...
function rgba3(r4, g3, b4, a4) {
  if (a4 <= 0) r4 = g3 = b4 = NaN;
  return new Rgb2(r4, g3, b4, a4);
}
...
function hsla3(h3, s4, l3, a4) {
  if (a4 <= 0) h3 = s4 = l3 = NaN;
  else if (l3 <= 0 || l3 >= 1) h3 = s4 = NaN;
  else if (s4 <= 0) h3 = NaN;
  return new Hsl2(h3, s4, l3, a4);
}
...
function labConvert2(o3) {
  ...
  var r4 = rgb2lrgb2(o3.r), g3 = rgb2lrgb2(o3.g), b4 = rgb2lrgb2(o3.b), y4 = xyz2lab2((0.2225045 * r4 + 0.7168786 * g3 + 0.0606169 * b4) / Yn2), x5, z2;
  if (r4 === g3 && g3 === b4) x5 = z2 = y4;
  else {
    x5 = xyz2lab2((0.4360747 * r4 + 0.3850649 * g3 + 0.1430804 * b4) / Xn2);
    z2 = xyz2lab2((0.0139322 * r4 + 0.0971045 * g3 + 0.7141733 * b4) / Zn2);
  }
  return new Lab2(116 * y4 - 16, 500 * (x5 - y4), 200 * (y4 - z2), o3.opacity);
}
function lab3(l3, a4, b4, opacity) {
  return arguments.length === 1 ? labConvert2(l3) : new Lab2(l3, a4, b4, opacity == null ? 1 : opacity);
}
function Lab2(l3, a4, b4, opacity) {
  this.l = +l3;
  this.a = +a4;
  this.b = +b4;
  this.opacity = +opacity;
...
define_default2(Lab2, lab3, extend2(Color2, {
  ...
  rgb: function() {
    ...
    z2 = Zn2 * lab2xyz2(z2);
    return new Rgb2(
      lrgb2rgb2(3.1338561 * x5 - 1.6168667 * y4 - 0.4906146 * z2),
      lrgb2rgb2(-0.9787684 * x5 + 1.9161415 * y4 + 0.033454 * z2),
      lrgb2rgb2(0.0719453 * x5 - 0.2289914 * y4 + 1.4052427 * z2),
      this.opacity
    );
  }
}));
...
function hcl3(h3, c8, l3, opacity) {
  return arguments.length === 1 ? hclConvert2(h3) : new Hcl2(h3, c8, l3, opacity == null ? 1 : opacity);
}
function Hcl2(h3, c8, l3, opacity) {
  this.h = +h3;
  this.c = +c8;
  this.l = +l3;
  this.opacity = +opacity;
...
function cubehelixConvert2(o3) {
  ...
  if (!(o3 instanceof Rgb2)) o3 = rgbConvert2(o3);
  var r4 = o3.r / 255, g3 = o3.g / 255, b4 = o3.b / 255, l3 = (BC_DA2 * b4 + ED2 * r4 - EB2 * g3) / (BC_DA2 + ED2 - EB2), bl = b4 - l3, k4 = (E2 * (g3 - l3) - C2 * bl) / D2, s4 = Math.sqrt(k4 * k4 + bl * bl) / (E2 * l3 * (1 - l3)), h3 = s4 ? Math.atan2(k4, bl) * degrees3 - 120 : NaN;
...
define_default2(Cubehelix2, cubehelix3, extend2(Color2, {
  ...
  rgb: function() {
    var h3 = isNaN(this.h) ? 0 : (this.h + 120) * radians2, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh5 = Math.cos(h3), sinh5 = Math.sin(h3);
    return new Rgb2(
...
function basis_default2(values) {
  ...
  return function(t7) {
    var i3 = t7 <= 0 ? t7 = 0 : t7 >= 1 ? (t7 = 1, n3 - 1) : Math.floor(t7 * n3), v1 = values[i3], v22 = values[i3 + 1], v0 = i3 > 0 ? values[i3 - 1] : 2 * v1 - v22, v32 = i3 < n3 - 1 ? values[i3 + 2] : 2 * v22 - v1;
    return basis2((t7 - i3 / n3) * n3, v0, v1, v22, v32);
  };
}
...
function hue2(a4, b4) {
  var d3 = b4 - a4;
  return d3 ? linear3(a4, d3 > 180 || d3 < -180 ? d3 - 360 * Math.round(d3 / 360) : d3) : constant_default3(isNaN(a4) ? b4 : a4);
}
function gamma2(y4) {
  return (y4 = +y4) === 1 ? nogamma2 : function(a4, b4) {
    return b4 - a4 ? exponential2(a4, b4, y4) : constant_default3(isNaN(a4) ? b4 : a4);
  };
}
function nogamma2(a4, b4) {
  var d3 = b4 - a4;
  return d3 ? linear3(a4, d3) : constant_default3(isNaN(a4) ? b4 : a4);
}
...
var rgb_default2 = function rgbGamma2(y4) {
  ...
  function rgb6(start2, end) {
    var r4 = color5((start2 = rgb3(start2)).r, (end = rgb3(end)).r), g3 = color5(start2.g, end.g), b4 = color5(start2.b, end.b), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t7) {
      start2.r = r4(t7);
      start2.g = g3(t7);
      start2.b = b4(t7);
...
function decompose_default2(a4, b4, c8, d3, e6, f4) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a4 * a4 + b4 * b4)) a4 /= scaleX, b4 /= scaleX;
  if (skewX = a4 * c8 + b4 * d3) c8 -= a4 * skewX, d3 -= b4 * skewX;
  if (scaleY = Math.sqrt(c8 * c8 + d3 * d3)) c8 /= scaleY, d3 /= scaleY, skewX /= scaleY;
  ...
  return {
    translateX: e6,
    translateY: f4,
    rotate: Math.atan2(b4, a4) * degrees4,
...
function interpolateTransform2(parse, pxComma, pxParen, degParen) {
  ...
  function rotate(a4, b4, s4, q) {
    if (a4 !== b4) {
      ...
      q.push({ i: s4.push(pop(s4) + "rotate(", null, degParen) - 2, x: number_default3(a4, b4) });
    } else if (b4) {
      s4.push(pop(s4) + "rotate(" + b4 + degParen);
    }
  }
  function skewX(a4, b4, s4, q) {
    if (a4 !== b4) {
      q.push({ i: s4.push(pop(s4) + "skewX(", null, degParen) - 2, x: number_default3(a4, b4) });
    } else if (b4) {
      s4.push(pop(s4) + "skewX(" + b4 + degParen);
    }
  }
...
var zoom_default2 = function zoomRho2(rho, rho2, rho4) {
  function zoom(p0, p1) {
    ...
    if (d22 < epsilon22) {
      ...
      S3 = (r1 - r0) / rho;
      i3 = function(t7) {
        var s4 = t7 * S3, coshr0 = cosh2(r0), u3 = w0 / (rho2 * d1) * (coshr0 * tanh2(rho * s4 + r0) - sinh2(r0));
        return [
          ux0 + u3 * dx,
          uy0 + u3 * dy,
...
function hsl5(hue5) {
  return function(start2, end) {
    var h3 = hue5((start2 = hsl4(start2)).h, (end = hsl4(end)).h), s4 = nogamma2(start2.s, end.s), l3 = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.s = s4(t7);
      start2.l = l3(t7);
...
function hcl4(hue5) {
  return function(start2, end) {
    var h3 = hue5((start2 = hcl3(start2)).h, (end = hcl3(end)).h), c8 = nogamma2(start2.c, end.c), l3 = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.c = c8(t7);
      start2.l = l3(t7);
...
function cubehelix4(hue5) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix9(start2, end) {
      var h3 = hue5((start2 = cubehelix3(start2)).h, (end = cubehelix3(end)).h), s4 = nogamma2(start2.s, end.s), l3 = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
      return function(t7) {
        start2.h = h3(t7);
        start2.s = s4(t7);
        start2.l = l3(Math.pow(t7, y4));
...
function ramp(range2) {
  ...
  return function(t7) {
    return range2[Math.max(0, Math.min(n3 - 1, Math.floor(t7 * n3)))];
  };
}
...
function controlPoints(x5) {
  ...
  for (i3 = 1; i3 < n3 - 1; ++i3) a4[i3] = 1, b4[i3] = 4, r4[i3] = 4 * x5[i3] + 2 * x5[i3 + 1];
  a4[n3 - 1] = 2, b4[n3 - 1] = 7, r4[n3 - 1] = 8 * x5[n3 - 1] + x5[n3];
  for (i3 = 1; i3 < n3; ++i3) m4 = a4[i3] / b4[i3 - 1], b4[i3] -= m4, r4[i3] -= m4 * r4[i3 - 1];
  a4[n3 - 1] = r4[n3 - 1] / b4[n3 - 1];
  for (i3 = n3 - 2; i3 >= 0; --i3) a4[i3] = (r4[i3] - a4[i3 + 1]) / b4[i3];
  b4[n3 - 1] = (x5[n3] + a4[n3 - 1]) / 2;
  for (i3 = 0; i3 < n3 - 1; ++i3) b4[i3] = 2 * x5[i3 + 1] - a4[i3 + 1];
  return [a4, b4];
}
...
function Gr() {
  return Gr = Object.assign || function(e6) {
    for (var r4 = 1; r4 < arguments.length; r4++) {
      var t7 = arguments[r4];
      for (var i3 in t7) Object.prototype.hasOwnProperty.call(t7, i3) && (e6[i3] = t7[i3]);
    }
    return e6;
...
function Lr(e6, r4) {
  ...
  for (i3 = 0; i3 < o3.length; i3++) t7 = o3[i3], r4.indexOf(t7) >= 0 || (n3[t7] = e6[t7]);
  return n3;
}
...
var en = function(e6, r4, t7) {
  if ("*" === e6) return true;
  if ((0, import_isFunction.default)(e6)) return e6(r4);
  ...
  return e6.length && r4.length && (u3 = [].concat(e6), r4.forEach(function(r5) {
    for (var i4 = function(i5) {
      ...
      if (en(l4, r5, o3)) {
        ...
        if (c8) {
          if ($i.includes(c8.type)) if ("inherit" === c8.background || "inherit" === c8.color) {
          ...
          } else (0, import_set2.default)(r5, d3, "url(#" + a5 + ")");
...
function v2() {
  return v2 = Object.assign || function(t7) {
    for (var i3 = 1; i3 < arguments.length; i3++) {
      var o3 = arguments[i3];
      for (var n3 in o3) Object.prototype.hasOwnProperty.call(o3, n3) && (t7[n3] = o3[n3]);
    }
    return t7;
...
var g = (0, import_react6.memo)(function(t7) {
  var o3, n3 = t7.position, r4 = t7.anchor, e6 = t7.children, l3 = Vt(), u3 = tt(), p3 = u3.animate, f4 = u3.config, g3 = Ft(), b4 = g3[0], w3 = g3[1], T3 = (0, import_react6.useRef)(false), C7 = void 0, E6 = false, P3 = w3.width > 0 && w3.height > 0, N2 = Math.round(n3[0]), V2 = Math.round(n3[1]);
  P3 && ("top" === r4 ? (N2 -= w3.width / 2, V2 -= w3.height + 14) : "right" === r4 ? (N2 += 14, V2 -= w3.height / 2) : "bottom" === r4 ? (N2 -= w3.width / 2, V2 += 14) : "left" === r4 ? (N2 -= w3.width + 14, V2 -= w3.height / 2) : "center" === r4 && (N2 -= w3.width / 2, V2 -= w3.height / 2), C7 = { transform: m2(N2, V2) }, T3.current || (E6 = true), T3.current = [N2, V2]);
  var j2 = useSpring({ to: C7, config: f4, immediate: !p3 || E6 }), O5 = v2({}, x3, l3.tooltip, { transform: null != (o3 = j2.transform) ? o3 : m2(N2, V2) });
...
var C4 = (0, import_react6.memo)(function(t7) {
...
var E3 = (0, import_react6.memo)(function(t7) {
...
var F = function() {
  var t7 = z();
  return A3(t7) ? (0, import_jsx_runtime2.jsx)(g, { position: t7.position, anchor: t7.anchor, children: t7.content }) : null;
};
var M = function(t7) {
...
function rgba4(r4, g3, b4, a4) {
  if (a4 <= 0) r4 = g3 = b4 = NaN;
  return new Rgb3(r4, g3, b4, a4);
}
...
function hsla4(h3, s4, l3, a4) {
  if (a4 <= 0) h3 = s4 = l3 = NaN;
  else if (l3 <= 0 || l3 >= 1) h3 = s4 = NaN;
  else if (s4 <= 0) h3 = NaN;
  return new Hsl3(h3, s4, l3, a4);
}
...
function labConvert3(o3) {
  ...
  var r4 = rgb2lrgb3(o3.r), g3 = rgb2lrgb3(o3.g), b4 = rgb2lrgb3(o3.b), y4 = xyz2lab3((0.2225045 * r4 + 0.7168786 * g3 + 0.0606169 * b4) / Yn3), x5, z2;
  if (r4 === g3 && g3 === b4) x5 = z2 = y4;
  else {
    x5 = xyz2lab3((0.4360747 * r4 + 0.3850649 * g3 + 0.1430804 * b4) / Xn3);
    z2 = xyz2lab3((0.0139322 * r4 + 0.0971045 * g3 + 0.7141733 * b4) / Zn3);
  }
  return new Lab3(116 * y4 - 16, 500 * (x5 - y4), 200 * (y4 - z2), o3.opacity);
}
function lab5(l3, a4, b4, opacity) {
  return arguments.length === 1 ? labConvert3(l3) : new Lab3(l3, a4, b4, opacity == null ? 1 : opacity);
}
function Lab3(l3, a4, b4, opacity) {
  this.l = +l3;
  this.a = +a4;
...
define_default3(Lab3, lab5, extend3(Color3, {
  ...
  rgb: function() {
    ...
    z2 = Zn3 * lab2xyz3(z2);
    return new Rgb3(
      lrgb2rgb3(3.1338561 * x5 - 1.6168667 * y4 - 0.4906146 * z2),
      lrgb2rgb3(-0.9787684 * x5 + 1.9161415 * y4 + 0.033454 * z2),
      lrgb2rgb3(0.0719453 * x5 - 0.2289914 * y4 + 1.4052427 * z2),
      this.opacity
    );
  }
}));
function xyz2lab3(t7) {
  return t7 > t33 ? Math.pow(t7, 1 / 3) : t7 / t23 + t04;
}
function lab2xyz3(t7) {
  return t7 > t14 ? t7 * t7 * t7 : t23 * (t7 - t04);
}
...
function hcl5(h3, c8, l3, opacity) {
  return arguments.length === 1 ? hclConvert3(h3) : new Hcl3(h3, c8, l3, opacity == null ? 1 : opacity);
}
function Hcl3(h3, c8, l3, opacity) {
  this.h = +h3;
  this.c = +c8;
...
function cubehelixConvert3(o3) {
  ...
  if (!(o3 instanceof Rgb3)) o3 = rgbConvert3(o3);
  var r4 = o3.r / 255, g3 = o3.g / 255, b4 = o3.b / 255, l3 = (BC_DA3 * b4 + ED3 * r4 - EB3 * g3) / (BC_DA3 + ED3 - EB3), bl = b4 - l3, k4 = (E4 * (g3 - l3) - C5 * bl) / D3, s4 = Math.sqrt(k4 * k4 + bl * bl) / (E4 * l3 * (1 - l3)), h3 = s4 ? Math.atan2(k4, bl) * degrees5 - 120 : NaN;
...
define_default3(Cubehelix3, cubehelix5, extend3(Color3, {
  ...
  rgb: function() {
    var h3 = isNaN(this.h) ? 0 : (this.h + 120) * radians3, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh5 = Math.cos(h3), sinh5 = Math.sin(h3);
    return new Rgb3(
...
function bisector_default2(f4) {
  let delta = f4;
  let compare = f4;
  if (f4.length === 1) {
    delta = (d3, x5) => f4(d3) - x5;
    compare = ascendingComparator2(f4);
  }
  function left(a4, x5, lo, hi2) {
    if (lo == null) lo = 0;
    if (hi2 == null) hi2 = a4.length;
...
function ascendingComparator2(f4) {
  return (d3, x5) => ascending_default3(f4(d3), x5);
}
...
function ordinal2() {
  var index4 = /* @__PURE__ */ new Map(), domain = [], range2 = [], unknown = implicit2;
  function scale(d3) {
    var key = d3 + "", i3 = index4.get(key);
    if (!i3) {
...
function basis_default4(values) {
  ...
  return function(t7) {
    var i3 = t7 <= 0 ? t7 = 0 : t7 >= 1 ? (t7 = 1, n3 - 1) : Math.floor(t7 * n3), v1 = values[i3], v22 = values[i3 + 1], v0 = i3 > 0 ? values[i3 - 1] : 2 * v1 - v22, v32 = i3 < n3 - 1 ? values[i3 + 2] : 2 * v22 - v1;
    return basis3((t7 - i3 / n3) * n3, v0, v1, v22, v32);
  };
}
...
function exponential3(a4, b4, y4) {
  return a4 = Math.pow(a4, y4), b4 = Math.pow(b4, y4) - a4, y4 = 1 / y4, function(t7) {
    return Math.pow(a4 + t7 * b4, y4);
  };
}
function hue3(a4, b4) {
  var d3 = b4 - a4;
  return d3 ? linear4(a4, d3 > 180 || d3 < -180 ? d3 - 360 * Math.round(d3 / 360) : d3) : constant_default6(isNaN(a4) ? b4 : a4);
}
function gamma3(y4) {
  return (y4 = +y4) === 1 ? nogamma3 : function(a4, b4) {
    return b4 - a4 ? exponential3(a4, b4, y4) : constant_default6(isNaN(a4) ? b4 : a4);
  };
}
function nogamma3(a4, b4) {
  var d3 = b4 - a4;
  return d3 ? linear4(a4, d3) : constant_default6(isNaN(a4) ? b4 : a4);
}
...
var rgb_default3 = function rgbGamma3(y4) {
  ...
  function rgb6(start2, end) {
    var r4 = color5((start2 = rgb4(start2)).r, (end = rgb4(end)).r), g3 = color5(start2.g, end.g), b4 = color5(start2.b, end.b), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t7) {
      start2.r = r4(t7);
      start2.g = g3(t7);
      start2.b = b4(t7);
...
function number_default5(a4, b4) {
  return a4 = +a4, b4 = +b4, function(t7) {
    return a4 * (1 - t7) + b4 * t7;
  };
}
...
function decompose_default3(a4, b4, c8, d3, e6, f4) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a4 * a4 + b4 * b4)) a4 /= scaleX, b4 /= scaleX;
  if (skewX = a4 * c8 + b4 * d3) c8 -= a4 * skewX, d3 -= b4 * skewX;
  if (scaleY = Math.sqrt(c8 * c8 + d3 * d3)) c8 /= scaleY, d3 /= scaleY, skewX /= scaleY;
  ...
  return {
    translateX: e6,
    translateY: f4,
    rotate: Math.atan2(b4, a4) * degrees6,
...
function interpolateTransform3(parse, pxComma, pxParen, degParen) {
  ...
  function rotate(a4, b4, s4, q) {
    if (a4 !== b4) {
      ...
      q.push({ i: s4.push(pop(s4) + "rotate(", null, degParen) - 2, x: number_default5(a4, b4) });
    } else if (b4) {
      s4.push(pop(s4) + "rotate(" + b4 + degParen);
    }
  }
  function skewX(a4, b4, s4, q) {
    if (a4 !== b4) {
      q.push({ i: s4.push(pop(s4) + "skewX(", null, degParen) - 2, x: number_default5(a4, b4) });
    } else if (b4) {
      s4.push(pop(s4) + "skewX(" + b4 + degParen);
    }
  }
...
var zoom_default3 = function zoomRho3(rho, rho2, rho4) {
  function zoom(p0, p1) {
    ...
    if (d22 < epsilon23) {
      ...
      S3 = (r1 - r0) / rho;
      i3 = function(t7) {
        var s4 = t7 * S3, coshr0 = cosh3(r0), u3 = w0 / (rho2 * d1) * (coshr0 * tanh3(rho * s4 + r0) - sinh3(r0));
        return [
          ux0 + u3 * dx,
          uy0 + u3 * dy,
...
function hsl7(hue5) {
  return function(start2, end) {
    var h3 = hue5((start2 = hsl6(start2)).h, (end = hsl6(end)).h), s4 = nogamma3(start2.s, end.s), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.s = s4(t7);
      start2.l = l3(t7);
...
function hcl6(hue5) {
  return function(start2, end) {
    var h3 = hue5((start2 = hcl5(start2)).h, (end = hcl5(end)).h), c8 = nogamma3(start2.c, end.c), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.c = c8(t7);
      start2.l = l3(t7);
...
function cubehelix6(hue5) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix9(start2, end) {
      var h3 = hue5((start2 = cubehelix5(start2)).h, (end = cubehelix5(end)).h), s4 = nogamma3(start2.s, end.s), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
      return function(t7) {
        start2.h = h3(t7);
        start2.s = s4(t7);
        start2.l = l3(Math.pow(t7, y4));
...
function locale_default2(locale7) {
  ...
  function formatPrefix4(specifier, value) {
    var f4 = newFormat((specifier = formatSpecifier2(specifier), specifier.type = "f", specifier)), e6 = Math.max(-8, Math.min(8, Math.floor(exponent_default2(value) / 3))) * 3, k4 = Math.pow(10, -e6), prefix2 = prefixes3[8 + e6 / 3];
    return function(value2) {
      return f4(k4 * value2) + prefix2;
    };
  }
...
function ticker2(year3, month3, week, day3, hour3, minute3) {
  ...
  function tickInterval(start2, stop2, count4) {
    ...
    if (i3 === tickIntervals.length) return year3.every(tickStep2(start2 / durationYear2, stop2 / durationYear2, count4));
    if (i3 === 0) return millisecond_default2.every(Math.max(tickStep2(start2, stop2, count4), 1));
    const [t7, step] = tickIntervals[target / tickIntervals[i3 - 1][2] < tickIntervals[i3][2] / target ? i3 - 1 : i3];
    return t7.every(step);
  }
  return [ticks2, tickInterval];
...
function formatLocale2(locale7) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      ...
      while (++i3 < n3) {
        if (specifier.charCodeAt(i3) === 37) {
          string.push(specifier.slice(j2, i3));
          if ((pad4 = pads2[c8 = specifier.charAt(++i3)]) != null) c8 = specifier.charAt(++i3);
          else pad4 = c8 === "e" ? " " : "0";
          if (format4 = formats2[c8]) c8 = format4(date, pad4);
          string.push(c8);
          j2 = i3 + 1;
  ...
  function newParse(specifier, Z) {
    return function(string) {
      var d3 = newDate2(1900, void 0, 1), i3 = parseSpecifier(d3, specifier, string += "", 0), week, day3;
      if (i3 != string.length) return null;
      if ("Q" in d3) return new Date(d3.Q);
      if ("s" in d3) return new Date(d3.s * 1e3 + ("L" in d3 ? d3.L : 0));
      if (Z && !("Z" in d3)) d3.Z = 0;
  ...
  function parseSpecifier(d3, specifier, string, j2) {
    ...
    while (i3 < n3) {
      ...
      if (c8 === 37) {
        c8 = specifier.charAt(i3++);
        parse = parses[c8 in pads2 ? specifier.charAt(i3++) : c8];
        if (!parse || (j2 = parse(d3, string, j2)) < 0) return -1;
      } else if (c8 != string.charCodeAt(j2++)) {
        return -1;
      }
...
function qe() {
  return qe = Object.assign || function(e6) {
    for (var r4 = 1; r4 < arguments.length; r4++) {
      var n3 = arguments[r4];
      for (var t7 in n3) Object.prototype.hasOwnProperty.call(n3, t7) && (e6[t7] = n3[t7]);
    }
    return e6;
...
function Se(e6, r4) {
  ...
  for (var n3 = 0, t7 = new Array(r4); n3 < r4; n3++) t7[n3] = e6[n3];
  return t7;
}
function Re(e6, r4) {
  ...
  if (Array.isArray(e6) || (n3 = function(e7, r5) {
    if (e7) {
      if ("string" == typeof e7) return Se(e7, r5);
    ...
    if (function(e7) {
      ...
      if (Array.isArray(e6.modifiers)) {
        for (var o3, i3 = [], u3 = function() {
          ...
          if ("brighter" === r5) i3.push(function(e8) {
            return e8.brighter(n4);
          });
          else if ("darker" === r5) i3.push(function(e8) {
            return e8.darker(n4);
          });
          else {
...
var fr = function(e6, r4) {
  ...
  if (Array.isArray(e6)) {
    var t7 = ordinal2(e6), o3 = function(e7) {
      return t7(n3(e7));
    };
  ...
  if ((0, import_isPlainObject2.default)(e6)) {
    ...
    if (function(e7) {
      ...
      if (Je(e6.scheme)) {
        ...
        var s4 = ordinal2($e[e6.scheme][e6.size || 9]), c8 = function(e7) {
          return s4(n3(e7));
        };
...
function bisector(f4) {
  ...
  if (f4.length !== 2) {
    ...
    compare1 = f4 === ascending || f4 === descending ? f4 : zero2;
    compare2 = f4;
    delta = f4;
  }
  function left(a4, x5, lo = 0, hi2 = a4.length) {
    if (lo < hi2) {
      if (compare1(x5, x5) !== 0) return hi2;
      do {
        const mid = lo + hi2 >>> 1;
  ...
  function right(a4, x5, lo = 0, hi2 = a4.length) {
    if (lo < hi2) {
      if (compare1(x5, x5) !== 0) return hi2;
      do {
        const mid = lo + hi2 >>> 1;
  ...
  function center(a4, x5, lo = 0, hi2 = a4.length) {
    const i3 = left(a4, x5, lo, hi2 - 1);
    return i3 > lo && delta(a4[i3 - 1], x5) > -delta(a4[i3], x5) ? i3 - 1 : i3;
  }
  return { left, center, right };
...
var ascendingBisect3 = bisector(ascending);
var bisectRight3 = ascendingBisect3.right;
var bisectLeft3 = ascendingBisect3.left;
var bisectCenter3 = bisector(number3).center;
...
function blurh(blur3, T3, S3, w3, h3) {
  for (let y4 = 0, n3 = w3 * h3; y4 < n3; ) {
    blur3(T3, S3, y4, y4 += w3, 1);
  }
}
function blurv(blur3, T3, S3, w3, h3) {
  for (let x5 = 0, n3 = w3 * h3; x5 < w3; ++x5) {
    blur3(T3, S3, x5, x5 + n3, w3);
  }
}
...
function blurf(radius) {
  ...
  return (T3, S3, start2, stop2, step) => {
    ...
    for (let i3 = start2, j2 = start2 + s0; i3 < j2; i3 += step) {
      sum5 += S3[Math.min(stop2, i3)];
    }
    for (let i3 = start2, j2 = stop2; i3 <= j2; i3 += step) {
      sum5 += S3[Math.min(stop2, i3 + s0)];
      T3[i3] = (sum5 + t7 * (S3[Math.max(start2, i3 - s1)] + S3[Math.min(stop2, i3 + s1)])) / w3;
      sum5 -= S3[Math.max(start2, i3 - s0)];
    }
  };
}
function bluri(radius) {
  ...
  return (T3, S3, start2, stop2, step) => {
    ...
    for (let i3 = start2, j2 = stop2; i3 <= j2; i3 += step) {
      sum5 += S3[Math.min(stop2, i3 + s4)];
      T3[i3] = sum5 / w3;
      sum5 -= S3[Math.max(start2, i3 - s4)];
    }
  };
}
...
function tickSpec(start2, stop2, count4) {
  const step = (stop2 - start2) / Math.max(0, count4), power = Math.floor(Math.log10(step)), error = step / Math.pow(10, power), factor = error >= e103 ? 10 : error >= e53 ? 5 : error >= e23 ? 2 : 1;
  let i1, i22, inc;
  if (power < 0) {
...
function tickIncrement3(start2, stop2, count4) {
  stop2 = +stop2, start2 = +start2, count4 = +count4;
  return tickSpec(start2, stop2, count4)[2];
}
function tickStep3(start2, stop2, count4) {
  stop2 = +stop2, start2 = +start2, count4 = +count4;
  const reverse4 = stop2 < start2, inc = reverse4 ? tickIncrement3(stop2, start2, count4) : tickIncrement3(start2, stop2, count4);
...
function rgba5(r4, g3, b4, a4) {
  if (a4 <= 0) r4 = g3 = b4 = NaN;
  return new Rgb4(r4, g3, b4, a4);
}
...
function rgb5(r4, g3, b4, opacity) {
  return arguments.length === 1 ? rgbConvert4(r4) : new Rgb4(r4, g3, b4, opacity == null ? 1 : opacity);
}
function Rgb4(r4, g3, b4, opacity) {
  this.r = +r4;
  this.g = +g3;
...
function hsla5(h3, s4, l3, a4) {
  if (a4 <= 0) h3 = s4 = l3 = NaN;
  else if (l3 <= 0 || l3 >= 1) h3 = s4 = NaN;
  else if (s4 <= 0) h3 = NaN;
  return new Hsl4(h3, s4, l3, a4);
}
...
function labConvert4(o3) {
  ...
  var r4 = rgb2lrgb4(o3.r), g3 = rgb2lrgb4(o3.g), b4 = rgb2lrgb4(o3.b), y4 = xyz2lab4((0.2225045 * r4 + 0.7168786 * g3 + 0.0606169 * b4) / Yn4), x5, z2;
  if (r4 === g3 && g3 === b4) x5 = z2 = y4;
  else {
    x5 = xyz2lab4((0.4360747 * r4 + 0.3850649 * g3 + 0.1430804 * b4) / Xn4);
    z2 = xyz2lab4((0.0139322 * r4 + 0.0971045 * g3 + 0.7141733 * b4) / Zn4);
  }
  return new Lab4(116 * y4 - 16, 500 * (x5 - y4), 200 * (y4 - z2), o3.opacity);
}
function lab7(l3, a4, b4, opacity) {
  return arguments.length === 1 ? labConvert4(l3) : new Lab4(l3, a4, b4, opacity == null ? 1 : opacity);
}
function Lab4(l3, a4, b4, opacity) {
  this.l = +l3;
  this.a = +a4;
  this.b = +b4;
  this.opacity = +opacity;
...
define_default4(Lab4, lab7, extend4(Color4, {
  ...
  rgb() {
    ...
    z2 = Zn4 * lab2xyz4(z2);
    return new Rgb4(
      lrgb2rgb4(3.1338561 * x5 - 1.6168667 * y4 - 0.4906146 * z2),
      lrgb2rgb4(-0.9787684 * x5 + 1.9161415 * y4 + 0.033454 * z2),
      lrgb2rgb4(0.0719453 * x5 - 0.2289914 * y4 + 1.4052427 * z2),
      this.opacity
    );
  }
}));
function xyz2lab4(t7) {
  return t7 > t34 ? Math.pow(t7, 1 / 3) : t7 / t24 + t06;
}
function lab2xyz4(t7) {
  return t7 > t16 ? t7 * t7 * t7 : t24 * (t7 - t06);
}
...
function hcl7(h3, c8, l3, opacity) {
  return arguments.length === 1 ? hclConvert4(h3) : new Hcl4(h3, c8, l3, opacity == null ? 1 : opacity);
}
function Hcl4(h3, c8, l3, opacity) {
  this.h = +h3;
  this.c = +c8;
  this.l = +l3;
  this.opacity = +opacity;
...
function cubehelixConvert4(o3) {
  ...
  if (!(o3 instanceof Rgb4)) o3 = rgbConvert4(o3);
  var r4 = o3.r / 255, g3 = o3.g / 255, b4 = o3.b / 255, l3 = (BC_DA4 * b4 + ED4 * r4 - EB4 * g3) / (BC_DA4 + ED4 - EB4), bl = b4 - l3, k4 = (E5 * (g3 - l3) - C6 * bl) / D4, s4 = Math.sqrt(k4 * k4 + bl * bl) / (E5 * l3 * (1 - l3)), h3 = s4 ? Math.atan2(k4, bl) * degrees7 - 120 : NaN;
...
define_default4(Cubehelix4, cubehelix7, extend4(Color4, {
  ...
  rgb() {
    var h3 = isNaN(this.h) ? 0 : (this.h + 120) * radians4, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh5 = Math.cos(h3), sinh5 = Math.sin(h3);
    return new Rgb4(
...
function basis_default5(values) {
  ...
  return function(t7) {
    var i3 = t7 <= 0 ? t7 = 0 : t7 >= 1 ? (t7 = 1, n3 - 1) : Math.floor(t7 * n3), v1 = values[i3], v22 = values[i3 + 1], v0 = i3 > 0 ? values[i3 - 1] : 2 * v1 - v22, v32 = i3 < n3 - 1 ? values[i3 + 2] : 2 * v22 - v1;
    return basis4((t7 - i3 / n3) * n3, v0, v1, v22, v32);
  };
}
...
function exponential4(a4, b4, y4) {
  return a4 = Math.pow(a4, y4), b4 = Math.pow(b4, y4) - a4, y4 = 1 / y4, function(t7) {
    return Math.pow(a4 + t7 * b4, y4);
  };
}
function hue4(a4, b4) {
  var d3 = b4 - a4;
  return d3 ? linear6(a4, d3 > 180 || d3 < -180 ? d3 - 360 * Math.round(d3 / 360) : d3) : constant_default7(isNaN(a4) ? b4 : a4);
}
function gamma4(y4) {
  return (y4 = +y4) === 1 ? nogamma4 : function(a4, b4) {
    return b4 - a4 ? exponential4(a4, b4, y4) : constant_default7(isNaN(a4) ? b4 : a4);
  };
}
function nogamma4(a4, b4) {
  var d3 = b4 - a4;
  return d3 ? linear6(a4, d3) : constant_default7(isNaN(a4) ? b4 : a4);
}
...
var rgb_default4 = function rgbGamma4(y4) {
  ...
  function rgb6(start2, end) {
    var r4 = color5((start2 = rgb5(start2)).r, (end = rgb5(end)).r), g3 = color5(start2.g, end.g), b4 = color5(start2.b, end.b), opacity = nogamma4(start2.opacity, end.opacity);
    return function(t7) {
      start2.r = r4(t7);
      start2.g = g3(t7);
      start2.b = b4(t7);
...
function number_default6(a4, b4) {
  return a4 = +a4, b4 = +b4, function(t7) {
    return a4 * (1 - t7) + b4 * t7;
  };
}
...
function decompose_default4(a4, b4, c8, d3, e6, f4) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a4 * a4 + b4 * b4)) a4 /= scaleX, b4 /= scaleX;
  if (skewX = a4 * c8 + b4 * d3) c8 -= a4 * skewX, d3 -= b4 * skewX;
  if (scaleY = Math.sqrt(c8 * c8 + d3 * d3)) c8 /= scaleY, d3 /= scaleY, skewX /= scaleY;
  ...
  return {
    translateX: e6,
    translateY: f4,
    rotate: Math.atan2(b4, a4) * degrees8,
...
function parseCss4(value) {
  const m4 = new (typeof DOMMatrix === "function" ? DOMMatrix : WebKitCSSMatrix)(value + "");
  return m4.isIdentity ? identity9 : decompose_default4(m4.a, m4.b, m4.c, m4.d, m4.e, m4.f);
}
function parseSvg4(value) {
  ...
  if (!(value = svgNode4.transform.baseVal.consolidate())) return identity9;
  value = value.matrix;
...
function interpolateTransform4(parse, pxComma, pxParen, degParen) {
  ...
  function translate(xa, ya, xb, yb, s4, q) {
    if (xa !== xb || ya !== yb) {
      var i3 = s4.push("translate(", null, pxComma, null, pxParen);
      q.push({ i: i3 - 4, x: number_default6(xa, xb) }, { i: i3 - 2, x: number_default6(ya, yb) });
    } else if (xb || yb) {
      s4.push("translate(" + xb + pxComma + yb + pxParen);
    }
  }
  function rotate(a4, b4, s4, q) {
    if (a4 !== b4) {
      ...
      q.push({ i: s4.push(pop(s4) + "rotate(", null, degParen) - 2, x: number_default6(a4, b4) });
    } else if (b4) {
      s4.push(pop(s4) + "rotate(" + b4 + degParen);
    }
  }
  function skewX(a4, b4, s4, q) {
    if (a4 !== b4) {
      q.push({ i: s4.push(pop(s4) + "skewX(", null, degParen) - 2, x: number_default6(a4, b4) });
    } else if (b4) {
      s4.push(pop(s4) + "skewX(" + b4 + degParen);
    }
  }
...
var zoom_default4 = function zoomRho4(rho, rho2, rho4) {
  function zoom(p0, p1) {
    ...
    if (d22 < epsilon24) {
      ...
      S3 = (r1 - r0) / rho;
      i3 = function(t7) {
        var s4 = t7 * S3, coshr0 = cosh4(r0), u3 = w0 / (rho2 * d1) * (coshr0 * tanh4(rho * s4 + r0) - sinh4(r0));
        return [
          ux0 + u3 * dx,
          uy0 + u3 * dy,
...
function hsl9(hue5) {
  return function(start2, end) {
    var h3 = hue5((start2 = hsl8(start2)).h, (end = hsl8(end)).h), s4 = nogamma4(start2.s, end.s), l3 = nogamma4(start2.l, end.l), opacity = nogamma4(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.s = s4(t7);
      start2.l = l3(t7);
...
function hcl8(hue5) {
  return function(start2, end) {
    var h3 = hue5((start2 = hcl7(start2)).h, (end = hcl7(end)).h), c8 = nogamma4(start2.c, end.c), l3 = nogamma4(start2.l, end.l), opacity = nogamma4(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.c = c8(t7);
      start2.l = l3(t7);
...
function cubehelix8(hue5) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix9(start2, end) {
      var h3 = hue5((start2 = cubehelix7(start2)).h, (end = cubehelix7(end)).h), s4 = nogamma4(start2.s, end.s), l3 = nogamma4(start2.l, end.l), opacity = nogamma4(start2.opacity, end.opacity);
      return function(t7) {
        start2.h = h3(t7);
        start2.s = s4(t7);
        start2.l = l3(Math.pow(t7, y4));
...
function formatSpecifier3(specifier) {
  if (!(match = re3.exec(specifier))) throw new Error("invalid format: " + specifier);
  var match;
...
function locale_default3(locale7) {
  var group4 = locale7.grouping === void 0 || locale7.thousands === void 0 ? identity_default6 : formatGroup_default3(map9.call(locale7.grouping, Number), locale7.thousands + ""), currencyPrefix = locale7.currency === void 0 ? "" : locale7.currency[0] + "", currencySuffix = locale7.currency === void 0 ? "" : locale7.currency[1] + "", decimal = locale7.decimal === void 0 ? "." : locale7.decimal + "", numerals = locale7.numerals === void 0 ? identity_default6 : formatNumerals_default3(map9.call(locale7.numerals, String)), percent = locale7.percent === void 0 ? "%" : locale7.percent + "", minus = locale7.minus === void 0 ? "−" : locale7.minus + "", nan = locale7.nan === void 0 ? "NaN" : locale7.nan + "";
  function newFormat(specifier) {
    specifier = formatSpecifier3(specifier);
    var fill = specifier.fill, align = specifier.align, sign2 = specifier.sign, symbol = specifier.symbol, zero3 = specifier.zero, width = specifier.width, comma = specifier.comma, precision = specifier.precision, trim = specifier.trim, type = specifier.type;
    if (type === "n") comma = true, type = "g";
    else if (!formatTypes_default3[type]) precision === void 0 && (precision = 12), trim = true, type = "g";
    if (zero3 || fill === "0" && align === "=") zero3 = true, fill = "0", align = "=";
    var prefix2 = symbol === "$" ? currencyPrefix : symbol === "#" && /[boxX]/.test(type) ? "0" + type.toLowerCase() : "", suffix = symbol === "$" ? currencySuffix : /[%p]/.test(type) ? percent : "";
    ...
    function format4(value) {
      ...
      if (type === "c") {
        ...
        var valueNegative = value < 0 || 1 / value < 0;
        value = isNaN(value) ? nan : formatType(Math.abs(value), precision);
        if (trim) value = formatTrim_default3(value);
        if (valueNegative && +value === 0 && sign2 !== "+") valueNegative = false;
        valuePrefix = (valueNegative ? sign2 === "(" ? sign2 : minus : sign2 === "-" || sign2 === "(" ? "" : sign2) + valuePrefix;
  ...
  function formatPrefix4(specifier, value) {
    var f4 = newFormat((specifier = formatSpecifier3(specifier), specifier.type = "f", specifier)), e6 = Math.max(-8, Math.min(8, Math.floor(exponent_default3(value) / 3))) * 3, k4 = Math.pow(10, -e6), prefix2 = prefixes4[8 + e6 / 3];
    return function(value2) {
      return f4(k4 * value2) + prefix2;
    };
  }
...
var millisecond3 = timeInterval(() => {
}, (date, step) => {
  date.setTime(+date + step);
}, (start2, end) => {
  return end - start2;
});
millisecond3.every = (k4) => {
  k4 = Math.floor(k4);
  if (!isFinite(k4) || !(k4 > 0)) return null;
...
var utcMinute3 = timeInterval((date) => {
  date.setUTCSeconds(0, 0);
}, (date, step) => {
  date.setTime(+date + step * durationMinute3);
}, (start2, end) => {
...
var utcHour3 = timeInterval((date) => {
  date.setUTCMinutes(0, 0, 0);
}, (date, step) => {
  date.setTime(+date + step * durationHour3);
}, (start2, end) => {
...
var unixDay = timeInterval((date) => {
  ...
  return Math.floor(date / durationDay3);
});
...
var utcMonth3 = timeInterval((date) => {
  date.setUTCDate(1);
  date.setUTCHours(0, 0, 0, 0);
}, (date, step) => {
  date.setUTCMonth(date.getUTCMonth() + step);
...
var utcYear3 = timeInterval((date) => {
  date.setUTCMonth(0, 1);
  date.setUTCHours(0, 0, 0, 0);
}, (date, step) => {
  date.setUTCFullYear(date.getUTCFullYear() + step);
...
function ticker3(year3, month3, week, day3, hour3, minute3) {
  ...
  function tickInterval(start2, stop2, count4) {
    ...
    if (i3 === tickIntervals.length) return year3.every(tickStep3(start2 / durationYear3, stop2 / durationYear3, count4));
    if (i3 === 0) return millisecond3.every(Math.max(tickStep3(start2, stop2, count4), 1));
    const [t7, step] = tickIntervals[target / tickIntervals[i3 - 1][2] < tickIntervals[i3][2] / target ? i3 - 1 : i3];
    return t7.every(step);
  }
  return [ticks2, tickInterval];
}
var [utcTicks3, utcTickInterval3] = ticker3(utcYear3, utcMonth3, utcSunday3, unixDay, utcHour3, utcMinute3);
var [timeTicks3, timeTickInterval3] = ticker3(timeYear, timeMonth, timeSunday, timeDay, timeHour, timeMinute);
...
function formatLocale3(locale7) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      ...
      while (++i3 < n3) {
        if (specifier.charCodeAt(i3) === 37) {
          string.push(specifier.slice(j2, i3));
          if ((pad4 = pads3[c8 = specifier.charAt(++i3)]) != null) c8 = specifier.charAt(++i3);
          else pad4 = c8 === "e" ? " " : "0";
          if (format4 = formats2[c8]) c8 = format4(date, pad4);
          string.push(c8);
          j2 = i3 + 1;
  ...
  function newParse(specifier, Z) {
    return function(string) {
      var d3 = newDate3(1900, void 0, 1), i3 = parseSpecifier(d3, specifier, string += "", 0), week, day3;
      if (i3 != string.length) return null;
      if ("Q" in d3) return new Date(d3.Q);
      if ("s" in d3) return new Date(d3.s * 1e3 + ("L" in d3 ? d3.L : 0));
      if (Z && !("Z" in d3)) d3.Z = 0;
      ...
      if ("V" in d3) {
        ...
        if (!("w" in d3)) d3.w = 1;
        if ("Z" in d3) {
          week = utcDate3(newDate3(d3.y, 0, 1)), day3 = week.getUTCDay();
          week = day3 > 4 || day3 === 0 ? utcMonday3.ceil(week) : utcMonday3(week);
          week = utcDay3.offset(week, (d3.V - 1) * 7);
          d3.y = week.getUTCFullYear();
          d3.m = week.getUTCMonth();
          d3.d = week.getUTCDate() + (d3.w + 6) % 7;
        } else {
          week = localDate3(newDate3(d3.y, 0, 1)), day3 = week.getDay();
        ...
        if (!("w" in d3)) d3.w = "u" in d3 ? d3.u % 7 : "W" in d3 ? 1 : 0;
        day3 = "Z" in d3 ? utcDate3(newDate3(d3.y, 0, 1)).getUTCDay() : localDate3(newDate3(d3.y, 0, 1)).getDay();
        d3.m = 0;
        d3.d = "W" in d3 ? (d3.w + 6) % 7 + d3.W * 7 - (day3 + 5) % 7 : d3.w + d3.U * 7 - (day3 + 6) % 7;
      }
      if ("Z" in d3) {
  ...
  function parseSpecifier(d3, specifier, string, j2) {
    ...
    while (i3 < n3) {
      ...
      if (c8 === 37) {
        c8 = specifier.charAt(i3++);
        parse = parses[c8 in pads3 ? specifier.charAt(i3++) : c8];
        if (!parse || (j2 = parse(d3, string, j2)) < 0) return -1;
      } else if (c8 != string.charCodeAt(j2++)) {
        return -1;
      }
...
function formatDayOfYear3(d3, p3) {
  return pad3(1 + timeDay.count(timeYear(d3), d3), p3, 3);
}
...
function formatWeekNumberSunday3(d3, p3) {
  return pad3(timeSunday.count(timeYear(d3) - 1, d3), p3, 2);
}
function dISO3(d3) {
  var day3 = d3.getDay();
...
function formatWeekNumberISO3(d3, p3) {
  d3 = dISO3(d3);
  return pad3(timeThursday.count(timeYear(d3), d3) + (timeYear(d3).getDay() === 4), p3, 2);
}
function formatWeekdayNumberSunday3(d3) {
  return d3.getDay();
}
function formatWeekNumberMonday3(d3, p3) {
  return pad3(timeMonday.count(timeYear(d3) - 1, d3), p3, 2);
}
...
function formatUTCDayOfYear3(d3, p3) {
  return pad3(1 + utcDay3.count(utcYear3(d3), d3), p3, 3);
}
...
function formatUTCWeekNumberSunday3(d3, p3) {
  return pad3(utcSunday3.count(utcYear3(d3) - 1, d3), p3, 2);
}
...
function formatUTCWeekNumberISO3(d3, p3) {
  d3 = UTCdISO3(d3);
  return pad3(utcThursday3.count(utcYear3(d3), d3) + (utcYear3(d3).getUTCDay() === 4), p3, 2);
}
function formatUTCWeekdayNumberSunday3(d3) {
  return d3.getUTCDay();
}
function formatUTCWeekNumberMonday3(d3, p3) {
  return pad3(utcMonday3.count(utcYear3(d3) - 1, d3), p3, 2);
}
...
function p2() {
  return p2 = Object.assign || function(t7) {
    for (var e6 = 1; e6 < arguments.length; e6++) {
      var i3 = arguments[e6];
      for (var n3 in i3) Object.prototype.hasOwnProperty.call(i3, n3) && (t7[n3] = i3[n3]);
    }
    return t7;
...
var B5 = function(i3) {
  var n3, r4, l3, c8, h3, g3, m4, f4, u3, v4, y4, b4 = i3.x, k4 = i3.y, x5 = i3.width, A6 = i3.height, W2 = i3.data, z2 = i3.direction, C7 = void 0 === z2 ? "left-to-right" : z2, B6 = i3.justify, w3 = void 0 !== B6 && B6, X2 = i3.textColor, Y2 = i3.background, H2 = void 0 === Y2 ? "transparent" : Y2, E6 = i3.opacity, j2 = void 0 === E6 ? 1 : E6, T3 = i3.symbolShape, L = void 0 === T3 ? "square" : T3, M2 = i3.symbolSize, F2 = void 0 === M2 ? 16 : M2, P3 = i3.symbolSpacing, R = void 0 === P3 ? 8 : P3, q = i3.symbolBorderWidth, V2 = void 0 === q ? 0 : q, D5 = i3.symbolBorderColor, G = void 0 === D5 ? "transparent" : D5, I = i3.onClick, N2 = i3.onMouseEnter, _ = i3.onMouseLeave, J = i3.toggleSerie, K5 = i3.effects, Q = (0, import_react8.useState)({}), U = Q[0], Z = Q[1], $ = Vt(), tt2 = (0, import_react8.useCallback)(function(t7) {
    if (K5) {
      var e6 = K5.filter(function(t8) {
        return "hover" === t8.on;
    ...
    null == N2 || N2(W2, t7);
  }, [N2, W2, K5]), et2 = (0, import_react8.useCallback)(function(t7) {
    if (K5) {
      var e6 = K5.filter(function(t8) {
        return "hover" !== t8.on;
      }).reduce(function(t8, e7) {
    ...
    null == _ || _(W2, t7);
  }, [_, W2, K5]), it2 = S2({ direction: C7, justify: w3, symbolSize: null != (n3 = U.symbolSize) ? n3 : F2, symbolSpacing: R, width: x5, height: A6 }), nt2 = it2.symbolX, ot2 = it2.symbolY, rt2 = it2.labelX, lt = it2.labelY, at = it2.labelAnchor, ct = it2.labelAlignment, st2 = [I, N2, _, J].some(function(t7) {
    return void 0 !== t7;
  }), dt = "function" == typeof L ? L : O4[L];
  return (0, import_jsx_runtime3.jsxs)("g", { transform: "translate(" + b4 + "," + k4 + ")", style: { opacity: null != (r4 = U.itemOpacity) ? r4 : j2 }, children: [(0, import_jsx_runtime3.jsx)("rect", { width: x5, height: A6, fill: null != (l3 = U.itemBackground) ? l3 : H2, style: { cursor: st2 ? "pointer" : "auto" }, onClick: function(t7) {
...
var w2 = function(e6) {
  var i3 = e6.data, n3 = e6.x, o3 = e6.y, r4 = e6.direction, l3 = e6.padding, a4 = void 0 === l3 ? 0 : l3, c8 = e6.justify, s4 = e6.effects, d3 = e6.itemWidth, h3 = e6.itemHeight, g3 = e6.itemDirection, m4 = void 0 === g3 ? "left-to-right" : g3, f4 = e6.itemsSpacing, u3 = void 0 === f4 ? 0 : f4, v4 = e6.itemTextColor, p3 = e6.itemBackground, y4 = void 0 === p3 ? "transparent" : p3, b4 = e6.itemOpacity, x5 = void 0 === b4 ? 1 : b4, S3 = e6.symbolShape, A6 = e6.symbolSize, W2 = e6.symbolSpacing, z2 = e6.symbolBorderWidth, C7 = e6.symbolBorderColor, O5 = e6.onClick, w3 = e6.onMouseEnter, X2 = e6.onMouseLeave, Y2 = e6.toggleSerie, H2 = k3({ itemCount: i3.length, itemWidth: d3, itemHeight: h3, itemsSpacing: u3, direction: r4, padding: a4 }).padding, E6 = "row" === r4 ? d3 + u3 : 0, j2 = "column" === r4 ? h3 + u3 : 0;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n3 + "," + o3 + ")", children: i3.map(function(e7, i4) {
    return (0, import_jsx_runtime3.jsx)(B5, { data: e7, x: i4 * E6 + H2.left, y: i4 * j2 + H2.top, width: d3, height: h3, direction: m4, justify: c8, effects: s4, textColor: v4, background: y4, opacity: x5, symbolShape: S3, symbolSize: A6, symbolSpacing: W2, symbolBorderWidth: z2, symbolBorderColor: C7, onClick: O5, onMouseEnter: w3, onMouseLeave: X2, toggleSerie: Y2 }, i4);
  }) });
};
var X = function(e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r4 = e6.translateX, l3 = void 0 === r4 ? 0 : r4, a4 = e6.translateY, c8 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h3 = e6.padding, g3 = void 0 === h3 ? 0 : h3, m4 = e6.justify, f4 = e6.itemsSpacing, u3 = void 0 === f4 ? 0 : f4, v4 = e6.itemWidth, p3 = e6.itemHeight, y4 = e6.itemDirection, b4 = e6.itemTextColor, S3 = e6.itemBackground, A6 = e6.itemOpacity, W2 = e6.symbolShape, z2 = e6.symbolSize, C7 = e6.symbolSpacing, O5 = e6.symbolBorderWidth, B6 = e6.symbolBorderColor, X2 = e6.onClick, Y2 = e6.onMouseEnter, H2 = e6.onMouseLeave, E6 = e6.toggleSerie, j2 = e6.effects, T3 = k3({ itemCount: i3.length, itemsSpacing: u3, itemWidth: v4, itemHeight: p3, direction: d3, padding: g3 }), L = T3.width, M2 = T3.height, F2 = x4({ anchor: s4, translateX: l3, translateY: c8, containerWidth: n3, containerHeight: o3, width: L, height: M2 }), P3 = F2.x, R = F2.y;
  return (0, import_jsx_runtime3.jsx)(w2, { data: i3, x: P3, y: R, direction: d3, padding: g3, justify: m4, effects: j2, itemsSpacing: u3, itemWidth: v4, itemHeight: p3, itemDirection: y4, itemTextColor: b4, itemBackground: S3, itemOpacity: A6, symbolShape: W2, symbolSize: z2, symbolSpacing: C7, symbolBorderWidth: O5, symbolBorderColor: B6, onClick: X2, onMouseEnter: Y2, onMouseLeave: H2, toggleSerie: "boolean" == typeof E6 ? void 0 : E6 });
};
var Y = { start: "left", middle: "center", end: "right" };
var H = function(t7, e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r4 = e6.translateX, l3 = void 0 === r4 ? 0 : r4, a4 = e6.translateY, c8 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h3 = e6.padding, g3 = void 0 === h3 ? 0 : h3, m4 = e6.justify, f4 = void 0 !== m4 && m4, u3 = e6.itemsSpacing, v4 = void 0 === u3 ? 0 : u3, p3 = e6.itemWidth, y4 = e6.itemHeight, b4 = e6.itemDirection, A6 = void 0 === b4 ? "left-to-right" : b4, W2 = e6.itemTextColor, z2 = e6.symbolSize, C7 = void 0 === z2 ? 16 : z2, O5 = e6.symbolSpacing, B6 = void 0 === O5 ? 8 : O5, w3 = e6.theme, X2 = k3({ itemCount: i3.length, itemWidth: p3, itemHeight: y4, itemsSpacing: v4, direction: d3, padding: g3 }), H2 = X2.width, E6 = X2.height, j2 = X2.padding, T3 = x4({ anchor: s4, translateX: l3, translateY: c8, containerWidth: n3, containerHeight: o3, width: H2, height: E6 }), L = T3.x, M2 = T3.y, F2 = "row" === d3 ? p3 + v4 : 0, P3 = "column" === d3 ? y4 + v4 : 0;
  t7.save(), t7.translate(L, M2), t7.font = w3.legends.text.fontSize + "px " + (w3.legends.text.fontFamily || "sans-serif"), i3.forEach(function(e7, i4) {
    var n4, o4, r5 = i4 * F2 + j2.left, l4 = i4 * P3 + j2.top, a5 = S2({ direction: A6, justify: f4, symbolSize: C7, symbolSpacing: B6, width: p3, height: y4 }), c9 = a5.symbolX, s5 = a5.symbolY, d4 = a5.labelX, h4 = a5.labelY, g4 = a5.labelAnchor, m5 = a5.labelAlignment;
    t7.fillStyle = null != (n4 = e7.color) ? n4 : "black", t7.fillRect(r5 + c9, l4 + s5, C7, C7), t7.textAlign = Y[g4], "central" === m5 && (t7.textBaseline = "middle"), t7.fillStyle = null != (o4 = null != W2 ? W2 : w3.legends.text.fill) ? o4 : "black", t7.fillText(String(e7.label), r5 + d4, l4 + h4);
  }), t7.restore();
};
...
//# sourceMappingURL=chunk-DQISAN4J.js.map
